...
import com.solvd.library.service.parser.JacksonLibraryParser;
import com.solvd.library.service.parser.JaxbLibraryParser;
import com.solvd.library.service.parser.StaxLibraryParser;
import com.solvd.library.service.parser.XmlValidator;
...
public class ParsersOldMain {

    private static final Logger LOGGER = LoggerFactory.getLogger(ParsersOldMain.class);
